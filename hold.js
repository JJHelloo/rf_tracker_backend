...
// Endpoint to receive location data from device and store in database
...
// Fetch device location and last connected user by ID to show on web interface
app.get('/api/device/location/:id', async (req, res) => {
  const { id } = req.params;
